...
var ProjectService = /** @class */ (function () {
    ...
    ProjectService.prototype.update = function (_id, updated) {
        return __awaiter(this, void 0, void 0, function () {
            var check;
            return __generator(this, function (_a) {
                check = this.projectModel.findByIdAndUpdate({ _id: _id }, updated);
                if (!check) {
    ...
    ProjectService.prototype.findOne = function (_Id) {
        return __awaiter(this, void 0, void 0, function () {
            var check;
            return __generator(this, function (_a) {
                check = this.projectModel.find({ _id: Object(_Id) }).exec();
                if (!check) {
                    throw new common_1.NotFoundException('project not found');
                }
                return [2 /*return*/, check];
    ...
    ProjectService.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.projectModel.find({}).exec()];
            });
        });
    };
