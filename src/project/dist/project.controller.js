...
var ProjectController = /** @class */ (function () {
    ...
    ProjectController.prototype.update = function (_Id, updated) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.projectService.update(_Id, updated)];
            });
        });
    };
    ProjectController.prototype.findAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.projectService.findAll()];
            });
        });
    };
    ProjectController.prototype.findOne = function (_id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.projectService.findOne(_id)];
            });
        });
    };
    ProjectController.prototype["delete"] = function (_id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.projectService["delete"](_id)];
            });
        });
    };
    __decorate([
    ...
    ], ProjectController.prototype, "findOne");
    __decorate([
        common_1.Delete('/:_id'),
        __param(0, common_1.Param('_id'))
